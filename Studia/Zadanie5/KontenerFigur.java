...
public class KontenerFigur {
    ...
    private void utworzFigury() {
        ...
        //listaFigur.add(new Elipsa(3,2));
        listaFigur.add(new Trojkat(4,4,5));
        listaFigur.add(new TrojkatRownoboczny(4));
    }
    ...
    private void podajStatystyke() {
        ...
        //System.out.println("Liczba elips                  :" + Elipsa.ileWszystkich());
        //System.out.println("Liczba kol                    :" + Kolo.ileWszystkich());
        System.out.println("Liczba trojkatow              :" + Trojkat.ileWszystkich());
        System.out.println("Liczba trojkatow rownobocznych:" + TrojkatRownoboczny.ileWszystkich());
